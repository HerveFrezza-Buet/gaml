...
namespace gaml {
  ...
  namespace partition {
    ...
    internal::KFold kfold(unsigned int k) {return internal::KFold(k);}
    internal::Chunk chunk(unsigned int k) {return internal::Chunk(k);}
    internal::Chunk leave_one_out(void)   {return internal::Chunk(1);}
  }
