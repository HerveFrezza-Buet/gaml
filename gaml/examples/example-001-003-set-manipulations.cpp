...
int main(int argc, char* argv[]) {
  ...
  // writing of degenerated cases in some templates. Moreover,
  // identity provides virtualized iterators that can be uses for
  // building up gaml::virtualized::sequence (see further examples).
