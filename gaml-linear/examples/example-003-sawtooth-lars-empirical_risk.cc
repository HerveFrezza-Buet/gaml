...
int main(int argc, char* argv[]) {
  ...
  // Learn a predictor
  auto learner = gaml::linear::lars::target_empirical_risk_learner<X>(phi, NB_FEATURES, empirical_risk, true, false);
  ...
  generate_plot("sawtooth_lars_empirical_risk", b, pred);
}
