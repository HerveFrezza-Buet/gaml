...
namespace gaml {
     ...
     */  
    template<unsigned int INPUT_DIM, typename PARSER>
        gaml::datasets::DownloadedDataset<INPUT_DIM, PARSER> make_downloaded_dataset(std::string url,
                const PARSER& parser) {
            return gaml::datasets::DownloadedDataset<INPUT_DIM, PARSER>(url, parser);
        }
    ...
    inline auto make_iris_dataset() {
        ...
        return gaml::make_downloaded_dataset<4>(url, parser);
    }
    ...
    inline auto make_diabetes_dataset() {
        ...
        return gaml::make_downloaded_dataset<10>(url, parser);
    }
    ...
    inline auto make_wine_dataset() {
        ...
        return gaml::make_downloaded_dataset<13>(url, parser);
